          ...
          <div className="lg:w-1/2">
            ...
            <div className="-mx-2 mt-6 flex items-center">
              <a className="mx-2" href="#" aria-label="Twitter">
                <svg
                  className="h-5 w-5 fill-current text-gray-700 hover:text-gray-600 dark:text-gray-200 dark:hover:text-gray-400"
          ...
          <div className="mt-8 lg:mt-0 lg:w-1/2">
            <div className="flex items-center justify-center lg:justify-end">
              <div className="max-w-lg">
                <img
                  className="h-64 w-full rounded-md object-cover object-center shadow"
